...
# db = client['real_estate_data2']
# read_collection = db['extract_process8']
try:
    client = MongoClient('mongodb+srv://hoangloccs:hoangloccs@cluster0-qcsey.gcp.mongodb.net/test?retryWrites=true')
